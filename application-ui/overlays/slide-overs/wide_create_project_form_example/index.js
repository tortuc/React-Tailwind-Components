                  ...
                  <div className="px-4 py-6 bg-gray-50 sm:px-6">
                    <div className="flex items-start justify-between space-x-3">
                      ...
                      <div className="h-7 flex items-center">
                        <button type="button" className="bg-white rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500" data-todo-at-click="open = false">
                          ...
                          <div className="space-y-5 sm:mt-0">
                            <div className="relative flex items-start">
                              <div className="absolute flex items-center h-5">
                                <input id="public_access" name="privacy" aria-describedby="public_access_description" type="radio" className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" checked="">
                              </div>
                            ...
                            <div className="relative flex items-start">
                              <div className="absolute flex items-center h-5">
                                <input id="restricted_access" name="privacy" aria-describedby="restricted_access_description" type="radio" className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                              </div>
                              <div className="pl-7 text-sm">
                            ...
                            <div className="relative flex items-start">
                              <div className="absolute flex items-center h-5">
                                <input id="private_access" name="privacy" aria-describedby="private_access_description" type="radio" className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                              </div>
                              <div className="pl-7 text-sm">
