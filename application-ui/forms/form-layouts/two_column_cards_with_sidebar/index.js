...
<div className="" style={{}}>
  ...
  <div className="lg:grid lg:grid-cols-12 lg:gap-x-5">
    <aside className="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
      <nav className="space-y-1">
          ...
          <a href="/" className="bg-gray-50 text-indigo-700 hover:text-indigo-700 hover:bg-white group rounded-md px-3 py-2 flex items-center text-sm font-medium" data-todo-x-state-on="Current" data-todo-x-state-off="Default" aria-current="page" data-todo-x-state-description="Current: &quot;bg-gray-50 text-indigo-700 hover:text-indigo-700 hover:bg-white&quot;, Default: &quot;text-gray-900 hover:text-gray-900 hover:bg-gray-50&quot;">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          ...
          <a href="/" className="text-gray-900 hover:text-gray-900 hover:bg-gray-50 group rounded-md px-3 py-2 flex items-center text-sm font-medium" data-todo-x-state-description="undefined: &quot;bg-gray-50 text-indigo-700 hover:text-indigo-700 hover:bg-white&quot;, undefined: &quot;text-gray-900 hover:text-gray-900 hover:bg-gray-50&quot;">
